# Monitoring the Power Platform: Model Driven Apps - The Monitoring Tool Part 2: Session Consumption and Analytics
...
The next section of this article will detail a powerful tool that can be leveraged to collect metrics and messages for the **Dynamics 365** platform, the **Monitor Tool**.

## The Monitoring Tool

**<u>The Monitoring Tool allows users and team members to collect messages and work together in debugging sessions</u>**. To begin, the **Monitoring Tool** can be launched from the **Power Apps Maker Portal**. Once launched, the ***Play Model Driven App*** button can be pressed to begin a session attached to the tool.
